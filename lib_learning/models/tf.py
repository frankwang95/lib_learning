...
class TFModel(object):
    ...
    Inputs
        ...
        optimizer <tf.Optimizer>: A function which performs a optimization step. The default is the tensorflow Gradient
    ...
    def train(self, train_in, train_out, batch_size=10, epochs=1, options=None, run_metadata=None):
